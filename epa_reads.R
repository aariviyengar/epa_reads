...
reads|>
  ...
  geom_hline(yintercept=mean(reads$epa_play_other_reads),linetype="dashed")+
  geom_vline(xintercept=mean(reads$epa_play_first_read),linetype="dashed")+
  theme_bw()+
...
ggsave(filename="epa_reads_uncaptioned.png",width=14,height=10,dpi="retina")
